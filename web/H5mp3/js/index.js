$(function () {
    var playerTrack = $("#player-track"), bgArtwork = $('#bg-artwork'), bgArtworkUrl, albumName = $('#album-name'),
        ...
        albums = ['从你的全世界路过', 'Sky High', 'The truth that you leave', '这支烟灭了以后'],
        trackNames = ['DN - 从你的全世界路过', 'Thomas Prime - Sky High', 'Pianoboy高至豪 - The truth that you leave', '张静波 - 这支烟灭了以后'],
        albumArtworks = ['_1', '_2', '_3', '_4'],
        trackUrl = ['mp3/1.mp3', 'mp3/2.mp3', 'mp3/3.mp3', 'mp3/4.mp3'],
